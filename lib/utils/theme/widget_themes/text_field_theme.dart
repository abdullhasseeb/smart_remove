...
class HkTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    errorMaxLines: 3,
    prefixIconColor: HkColors.darkerGrey,
    suffixIconColor: HkColors.darkerGrey,
    labelStyle: const TextStyle().copyWith(fontSize: HkSizes.fontSizeMd, color: HkColors.darkGrey),
    hintStyle: const TextStyle().copyWith(fontSize: HkSizes.fontSizeSm, color: HkColors.darkGrey),
